...
export default function Home() {
  ...
  return (
    <main className="bg-bgMain min-h-screen text-white dark:bg-bgMain dark:text-white">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col pt-[15vh] sm:pt-[23vh] items-center justify-center min-h-[80vh] text-center gap-4 sm:gap-6 px-4">
          ...
          <h1 className="text-4xl font-inter sm:text-6xl md:text-7xl font-bold max-w-4xl leading-tight text-black dark:text-white">
          ...
          <Button
            ...
            className="px-6 sm:px-8 py-4 sm:py-6 font-instrument text-xl sm:text-2xl bg-black dark:bg-white text-white dark:text-black hover:bg-black/90 dark:hover:bg-white/90 transition-all duration-200 flex items-center gap-2"
          >
            {isAiFetching ? (
              <>
